...
export default async function ComprarRecursoExitoPage({ searchParams }: Props) {
  ...
  if (!exito) {
    return (
      <div className="max-w-lg mx-auto px-4 py-24 text-center">
        ...
        <Link href="/recursos" className="btn-primary">Ver más recursos</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-24 text-center">
      ...
      <Link href={`/leer/recurso/${token}`} className="btn-primary">Abrir recurso →</Link>
    </div>
  );
}
