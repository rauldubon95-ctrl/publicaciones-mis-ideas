      ...
      <div className="grid sm:grid-cols-[auto_1fr] gap-10 items-start">
        ...
        <div className="mx-auto sm:mx-0">
          ...
          >
            {libro.imagenPortada ? (
              ...
              <div className="w-full flex items-center justify-center bg-linear-to-br from-brand-50 to-zinc-100" style={{ height: 330 }}>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-zinc-500 border-t border-zinc-100 pt-4">
            ...
            {esDePago && libro.precioCentavos != null && (
              <div className="flex items-start gap-1.5">
                <svg className="w-4 h-4 text-zinc-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <PrecioConConversion centavosUSD={libro.precioCentavos} tamano="sm" />
              </div>
            )}
            {libro.precioCentavos === 0 && (
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-medium text-emerald-700 text-sm">Gratis</span>
              </div>
            )}
            <div className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {puedeDescargar ? (
            <>
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-brand-700 hover:bg-brand-800 text-white font-semibold px-8 py-4 rounded-xl transition-colors text-base shadow-xs w-full sm:w-auto"
              >
