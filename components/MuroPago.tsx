...
export default function MuroPago({
  publicacionId,
  titulo,
  precioCentavos,
}: Props) {
    ...
    <div className="relative mt-8 mb-12">
      ...
      <div className="border border-amber-200 bg-gradient-to-br from-amber-50 to-white rounded-2xl p-8 shadow-sm">
        ...
        <h2 className="text-center text-xl font-serif font-semibold text-zinc-900 mb-2">
          Continúa leyendo por ${precio} USD
        </h2>
        <p className="text-center text-sm text-zinc-500 mb-6 max-w-md mx-auto leading-relaxed">
          Compra única que te da acceso permanente a{" "}
          <span className="text-zinc-700 font-medium">«{titulo}»</span>. El
          enlace para abrirlo te llega por correo.
        </p>
